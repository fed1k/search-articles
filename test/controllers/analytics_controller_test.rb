...
class AnalyticsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create analytic" do
    assert_difference("Analytic.count") do
      post analytics_url, params: { analytic: { ip: @analytic.ip, searchQuery: @analytic.searchQuery } }
    end
  ...
  test "should update analytic" do
    patch analytic_url(@analytic), params: { analytic: { ip: @analytic.ip, searchQuery: @analytic.searchQuery } }
